...
from .views import (
    ManageCourseListView, CreateCourseView, UpdateCourseView,
    DeleteCourseView, CourseModuleUpdateView, ContentCreateUpdateView,
...
urlpatterns = [
    ...
    path("<pk>/edit/", UpdateCourseView.as_view(), name="edit_course"),
    path("<pk>/delete/", DeleteCourseView.as_view(), name="delete_course"),
